...
def most_common_crimes():
    ...
    def upload_file():
        ...
        if file:
            ...
            global_functions.upload_to_sheets(file)
        else:
    ...
    show_chat_btn = tk.Button(
        most_common_crimes_window, text="Open Chat", command=global_functions.open_chat, height=1, width=12)
    show_chat_btn.grid(row=2, column=2)
